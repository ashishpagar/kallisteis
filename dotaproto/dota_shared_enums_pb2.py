...
_EDOTAPLAYERMMRTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='k_EDOTAPlayerMMRType_1v1Competitive_UNUSED', index=5, number=5,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
