...
from dotaproto import econ_shared_enums_pb2 as econ__shared__enums__pb2
...
_CMSGGCTOGCBROADCASTMESSAGEFROMSUB.fields_by_name['account_id_list'].has_options = True
_CMSGGCTOGCBROADCASTMESSAGEFROMSUB.fields_by_name['account_id_list']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
_CMSGGCTOGCBROADCASTMESSAGEFROMSUB.fields_by_name['steam_id_list'].has_options = True
_CMSGGCTOGCBROADCASTMESSAGEFROMSUB.fields_by_name['steam_id_list']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
_CMSGGCTOCLIENTCURRENCYPRICEPOINTS_CURRENCY.fields_by_name['currency_price'].has_options = True
_CMSGGCTOCLIENTCURRENCYPRICEPOINTS_CURRENCY.fields_by_name['currency_price']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
_CMSGGCTOCLIENTCURRENCYPRICEPOINTS.fields_by_name['price_key'].has_options = True
_CMSGGCTOCLIENTCURRENCYPRICEPOINTS.fields_by_name['price_key']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
