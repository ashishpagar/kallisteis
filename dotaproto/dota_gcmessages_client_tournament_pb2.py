...
_CMSGDOTATOURNAMENT_TEAM.fields_by_name['players']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
_CMSGDOTATOURNAMENT_TEAM.fields_by_name['player_buyin'].has_options = True
_CMSGDOTATOURNAMENT_TEAM.fields_by_name['player_buyin']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
_CMSGDOTATOURNAMENT_TEAM.fields_by_name['player_skill_level'].has_options = True
_CMSGDOTATOURNAMENT_TEAM.fields_by_name['player_skill_level']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
_CMSGDOTATOURNAMENTSTATECHANGE.fields_by_name['merged_tournament_ids'].has_options = True
_CMSGDOTATOURNAMENTSTATECHANGE.fields_by_name['merged_tournament_ids']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
